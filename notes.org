...
*** TODO login page
*** TODO login/logout link somewhere on existing page
...
** TODO when a new message is added to a thread page, scroll down if the user is already at or near the bottom
* Notes
