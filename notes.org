...
** TODO Add a way to delete images/comments/threads/boards
** TODO Check whether the thread is active before displaying certain things
** TODO Re-write the database interactions in boards.erl to use the db: package more effectively (common is already a dependency)
